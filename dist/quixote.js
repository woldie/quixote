...
Me.prototype.diffDescriptor = function diffDescriptor(result, key, descriptor, expected) {
	...
	if (typeof expectedValue === "string" || typeof expectedValue === "boolean" || typeof expectedValue === "number" ||
		...
		console.log("diffing " + expectedValue + " for " + key + " against " + descriptor);
		...
		for (var i = 0; i < childKeys.length; i++) {
			...
			this.diffDescriptor(result, childKey, descriptor[childKey], expectedValue[childKey]);
		}
	}
	else {
		console.log("Error, nothing to diff: " + key + " " + descriptor + " " + expectedValue);
	}
...
},{"../util/ensure.js":25,"../values/position.js":32,"./position_descriptor.js":11,"./relative_position.js":12}],4:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../util/oop.js":26,"../values/value.js":34}],5:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../q_element.js":19,"../util/ensure.js":25,"../values/position.js":32,"./element_size.js":6,"./position_descriptor.js":11,"./relative_position.js":12}],6:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../q_element.js":19,"../util/ensure.js":25,"../values/size.js":33,"./relative_size.js":13,"./size_descriptor.js":14,"./size_multiple.js":15}],7:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
ElementVisibleEdge.prototype.value = function value() {
	...
	var clipEdgeOffset = clipEdgeOffsets[this._position];
	var elementEdgePosition = this._element[this._position].value();

	// the clip edge we return defaults to the element's edge position, in Pixels
	var elementClipEdgePosition = elementEdgePosition.toPixels();

	// if the clipEdge is defined, then it will not be an instance of NoPixels
	if(!(clipEdgeOffset instanceof NoPixels)) {
		// if the element is fully clipped in x or y, then the edge is not visible
		if(clipEdgeOffsets.width.toPixels() <= 0 || clipEdgeOffsets.height.toPixels() <= 0) {
			return notVisibleEdge(this._position);
		}
		...
		switch(this._position) {
			case LEFT:
			case TOP:
				elementClipEdgePosition = Pixels.max(elementEdgePosition.toPixels().plus(clipEdgeOffset), elementEdgePosition.toPixels());
				break;
			case RIGHT:
			case BOTTOM:
				elementClipEdgePosition = Pixels.min(elementEdgePosition.toPixels().plus(clipEdgeOffset), elementEdgePosition.toPixels());
				break;
		}
	}

	if (this._position === RIGHT || this._position === LEFT) return Position.x(elementClipEdgePosition);
	else return Position.y(elementClipEdgePosition);
};
...
},{"../normalize/clip_style.js":18,"../q_element.js":19,"../util/ensure.js":25,"../util/shim.js":27,"../util/style_util.js":28,"../values/no_pixels.js":30,"../values/pixels.js":31,"../values/position.js":32,"./element_edge.js":5,"./element_size.js":6,"./position_descriptor.js":11,"./relative_position.js":12}],8:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../q_element.js":19,"../util/ensure.js":25,"../values/size.js":33,"./position_descriptor.js":11,"./relative_size.js":13,"./size_descriptor.js":14,"./size_multiple.js":15}],9:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../q_frame.js":21,"../util/ensure.js":25,"../values/position.js":32,"./position_descriptor.js":11}],10:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../q_frame.js":21,"../util/ensure.js":25,"../values/size.js":33,"./size_descriptor.js":14}],11:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
/*jshint newcap:false */
"use strict";
...
},{"../util/ensure.js":25,"../util/oop.js":26,"../values/position.js":32,"./descriptor.js":4,"./relative_position.js":12}],12:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../values/pixels.js":31,"../values/position.js":32,"../values/size.js":33,"../values/value.js":34,"./descriptor.js":4,"./element_size.js":6,"./position_descriptor.js":11}],13:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../values/size.js":33,"../values/value.js":34,"./descriptor.js":4,"./size_descriptor.js":14,"./size_multiple.js":15}],14:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
/*jshint newcap:false */
"use strict";
...
},{"../util/ensure.js":25,"../util/oop.js":26,"../values/size.js":33,"./descriptor.js":4,"./relative_size.js":13,"./size_multiple.js":15}],15:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../values/size.js":33,"./descriptor.js":4,"./size_descriptor.js":14}],16:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../q_frame.js":21,"../util/ensure.js":25,"../values/position.js":32,"./position_descriptor.js":11}],17:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../values/size.js":33,"./relative_size.js":13,"./size_descriptor.js":14,"./size_multiple.js":15}],18:[function(require,module,exports){
// Copyright (c) 2015 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../util/style_util.js":28,"../values/no_pixels.js":30,"../values/position.js":32,"../values/size.js":33}],19:[function(require,module,exports){
...
},{"../vendor/async-1.4.2.js":35,"./q_element.js":19,"./q_element_list.js":20,"./q_page.js":22,"./q_viewport.js":23,"./quixote.js":24,"./util/ensure.js":25,"./util/shim.js":27}],22:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"./q_frame.js":21,"./util/ensure.js":25,"./values/size.js":33}],25:[function(require,module,exports){
...
},{"../../vendor/camelcase-1.0.1-modified.js":36,"./ensure":25}],29:[function(require,module,exports){
// Copyright (c) 2015 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/oop.js":26,"./value.js":34}],30:[function(require,module,exports){
// Copyright (c) 2015 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"./css_length.js":29,"./value.js":34}],31:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"./css_length.js":29,"./value.js":34}],32:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"./css_length.js":29,"./pixels.js":31,"./size.js":33,"./value.js":34}],33:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"./css_length.js":29,"./pixels.js":31,"./value.js":34}],34:[function(require,module,exports){
// Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
"use strict";
...
},{"../util/ensure.js":25,"../util/oop.js":26,"../util/shim.js":27}],35:[function(require,module,exports){
...
//# sourceMappingURL=data:application/json;charset:utf-8;base64,
